        ...
        <div>
              <header id="navbrod">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <Link class="navbar-brand text-white" to='/super-admin/control-admins'><i className="fa-solid fa-angles-left"></i> Home </Link>
                    <div class="collapse navbar-collapse" id="nvbCollapse">
                        <ul class="navbar-nav ml-auto nav-menu">
                            <li class="nav-item pl-1">
                                <Link class="nav-link" to="/super-admin/broadcast/received"><i className="fa-solid fa-folder-open"></i>Received</Link>
                            </li>
                            {/* <li class="nav-item pl-1">
