...
// 	BroadcastMessage chan *types.Message
// 	Clients          map[string]*Client
// 	// UserService      user.IUserService
// 	//  ----------------------------------
// 	MessageService message.IMessageService
// 	ProductUpdate  chan *types.ProductUpdate
// }
...
// 		BroadcastMessage: make(chan *types.Message),
// 		Clients:          map[string]*Client{},
// 		ProductUpdate:    make(chan *types.ProductUpdate),
...
// func (mainbh *MainBroadcastHub) BroadcastNewMessage(mes *types.Message) {
