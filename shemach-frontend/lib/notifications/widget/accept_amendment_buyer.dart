...
class BuyerAcceptTransactionAmendment extends StatefulWidget {
  ...
  BuyerAcceptTransactionAmendment(this.transactionReq, this.transaction,
      {Key? key})
      : super(key: key);

  @override
  State<BuyerAcceptTransactionAmendment> createState() =>
      _BuyerAcceptTransactionAmendmentState();
}

class _BuyerAcceptTransactionAmendmentState
    extends State<BuyerAcceptTransactionAmendment> {
  @override
