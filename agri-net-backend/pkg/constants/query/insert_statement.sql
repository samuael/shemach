...
insert into messages(id , targets, lang , data,created_by, created_at) values
  (4, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,4, 1650126183),
  (5, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,4, 1650126186),
 ...
 (10, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131414),
 (11, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131482),
 (12, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131515),
 (13, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131559),
 (14, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131587),
 (15, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131593),
 (16, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131618),
 (17, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131634),
 (18, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650131662),
 (19, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650290359),
 (20, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650290360),
 (21, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,2, 1650290362),
 (22, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,3, 1650790259),
 (23, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,3, 1650790567),
 (24, ARRAY [-1] , 'all' , 'Welcome to Agri-net systems' ,3, 1650790664);
