...
<body>
    <h1 style="background-color:#00FF00";color:#fff >  shemach  </h1>
    {{if .NewPassword}}
		<p> Hi {{.Fullname}}, this is your new password for shemach systems <br>
		</p>
	{{else }}
	...
	<hr>
	<i> shemach Systems <small>  shemach ( Agricultural Products commercial network ) </small></i> 
	<hr>
	</body>
</html>`
...
<body>
    <h1 style="background-color:#00FF00";color:#fff > shemach Systems </h1>
		<p> Hi {{.Fullname }}, According to your action in shemach systems, this email is sent to confirm the email address.<br>
